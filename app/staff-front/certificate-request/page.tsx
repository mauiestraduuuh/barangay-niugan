          ...
          <div className="bg-white p-6 rounded-xl w-96">
            ...
            {modalType === "VIEW" && selectedRequest && (
              <div className="space-y-2">
                ...
                <p>
                  <strong>Requested At:</strong> {new Date(selectedRequest.requested_at).toLocaleString()}
                </p>
                {selectedRequest.pickup_date && (
                  <p>
                    <strong>Pickup Date:</strong> {selectedRequest.pickup_date} {selectedRequest.pickup_time}
                  </p>
                )}
