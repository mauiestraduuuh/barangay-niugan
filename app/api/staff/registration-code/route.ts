...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error("STAFF GET /registration-code error:", error);
...
export async function POST(req: NextRequest) {
  try {
    ...
    console.error("STAFF POST /registration-code error:", error);
    return NextResponse.json(
...
export async function PUT(req: NextRequest) {
  try {
    ...
    console.error("STAFF PUT /registration-code error:", error);
    return NextResponse.json(
