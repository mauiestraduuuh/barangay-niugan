...
{activeTab === "submit" && (
  <div className="space-y-6">
    {/* <h1 className="text-3xl font-bold text-center text-gray-800">Submit Complaint</h1> if gusto ko lagyan ng title this */}
    {infoMessage && (
  ...
  <button
    onClick={() => {
      ...
      if (fileInputRef.current) {
        fileInputRef.current.value = ""; // <-- clears the filename
      }
    }}
...
<div className="mt-6 flex justify-center">
  <button
    ...
    disabled={loading}
    className=" px-4 py-2  bg-gradient-to-br from-black via-red-800 to-black text-white py-3 rounded-lg font-semibold hover:from-red-700 transition-all duration-200 shadow-md disabled:opacity-50"
  >
